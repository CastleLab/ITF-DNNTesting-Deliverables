...
class ModelEvaluationPage(tk.Frame):
    ...
    def _create_dataset_mutation_page(self, ):
        dataset_preparation_frame = tk.Frame(self.model_evaluation_window)
    ...
    def evaluate_model(self):
        ...
        if not os.path.exists(mutate_path.replace("/root/", "")):
            ...
            dnnTest.mutate_image("directory", f"/root/MetaHand/tools/yolov7/{data_name}/images/train",
                                 ...
                                 "darknet")
            shutil.move(f"MetaHand/tools/yolov7/{data_name}/{mutate_type}/{mutate_type}/object_gaussian_{mutate_strength}_fixMutRatio_centerXY_{mutate_ratio}",
                        f"MetaHand/tools/yolov7/{data_name}/{mutate_type}/object_gaussian_{mutate_strength}_fixMutRatio_centerXY_{mutate_ratio}")

        print(f"Finish mutating images, start evaluating the model.")
    ...
    def model_evaluation_page(self):
        ...
        self.model_evaluation_window.title("Model Evaluation")
